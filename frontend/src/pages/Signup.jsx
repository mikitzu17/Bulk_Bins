        ...
        <div className="relative w-full min-h-screen flex items-center justify-center p-6 bg-slate-950 font-sans selection:bg-primary-500/30 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-[440px] animate-fade-in-up">
                <div className="glass p-10 md:p-12 relative w-full overflow-hidden">
                    ...
                    <div className="mt-8 text-slate-900 dark:text-white font-medium text-sm opacity-80 text-center">
                        Already have an account? <Link to="/login" className="text-primary-500 hover:text-primary-600 font-black tracking-wide transition-colors mt-2 inline-block text-base">Sign in here</Link>
                    </div>
                </div>
            </div>
        </div>
