            ...
            <div className="relative z-10 w-full max-w-[440px] animate-fade-in-up">
                <div className="glass p-8 md:p-10 relative w-full overflow-hidden">
                    ...
                    <div className="mt-8 text-slate-900 dark:text-white font-medium text-sm opacity-80 text-center">
                        ...
                        <Link to="/signup" className="text-primary-500 hover:text-primary-600 font-black tracking-wide transition-colors mt-2 inline-block text-base">Create bulk account</Link>
                    </div>
                </div>
            </div>
        </div>
