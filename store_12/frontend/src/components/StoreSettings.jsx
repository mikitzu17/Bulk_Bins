    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-serif font-black tracking-tight text-slate-900 dark:text-white">Store Settings</h1>
                    <p className="text-slate-900 dark:text-white text-sm font-black mt-1">Manage your business profile and team members</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 p-2 rounded-2xl bg-slate-100/50 dark:bg-slate-800/50 w-fit">
                {['General', 'Team', 'Account'].map((tab) => (
                    <button
                        ...
                        className={`px-6 py-2 rounded-xl font-black transition-all duration-300 ${activeSection === tab
                    ...
                    <form onSubmit={handleUpdateSettings} className="space-y-6 max-w-2xl">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Store Name</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Currency</label>
                                <div className="relative">
                            ...
                            <div className="col-span-1 md:col-span-2 space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Primary Contact Email</label>
                                <div className="relative">
                            ...
                            <div className="col-span-1 md:col-span-2 space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Secondary Contact Email</label>
                                <div className="relative">
                                    <Mail className="absolute left-3 top-3.5 w-5 h-5 text-slate-700 dark:text-slate-200" />
                                    <input
                                        type="email"
                            ...
                            <div className="col-span-1 md:col-span-2 space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Business Logo URL</label>
                                <div className="relative">
                                    <Settings className="absolute left-3 top-3.5 w-5 h-5 text-slate-700 dark:text-slate-200" />
                                    <input
                                        type="text"
            ...
            {activeSection === 'Team' && (
                <div className="space-y-8">
                    ...
                    <div className={cardClass}>
                        ...
                        <form onSubmit={handleAddMember} className="flex flex-col md:flex-row gap-4 items-end">
                            <div className="flex-1 space-y-2 w-full">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Email Address</label>
                                <input
                                    type="email"
                            ...
                            <div className="w-full md:w-48 space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Role</label>
                                <CustomSelect
                        ...
                        <p className="mt-4 text-sm text-slate-900 dark:text-white font-black flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-black px-2 text-slate-900 dark:text-white">Team Members ({members.length})</h3>
                                ...
                                <div key={member.user_id} className={`${cardClass} flex flex-col md:flex-row items-center justify-between gap-6 py-6`}>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-900 dark:text-white text-sm font-bold">{member.email}</p>
                                        </div>
                                    </div>
            ...
            {activeSection === 'Account' && (
                <div className={cardClass}>
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-6 max-w-2xl">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Full Name</label>
                                <div className="relative">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-black text-slate-900 dark:text-white">Personal Registered Email</label>
                                <div className="relative">
                                    <Mail className="absolute left-3 top-3.5 w-5 h-5 text-slate-700 dark:text-slate-200" />
                                    <input
                                        type="email"
                        ...
                        <div className="pt-4">
                            ...
                            <p className="mt-4 text-xs text-slate-900 dark:text-white font-black italic">
