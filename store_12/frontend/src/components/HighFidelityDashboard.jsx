...
const HighFidelityDashboard = ({
        ...
        datasets: [
            {
                ...
                backgroundColor: 'rgba(16, 185, 129, 0.15)', // Increased opacity for better visibility
                tension: 0.4,
                pointRadius: 0,
                borderWidth: 3,
            },
            {
                ...
                backgroundColor: 'rgba(59, 130, 246, 0.15)', // Increased opacity for better visibility
                tension: 0.4,
                pointRadius: 0,
                borderWidth: 3,
            }
    ...
    return (
        <div className="space-y-6 text-slate-900 dark:text-white animate-in fade-in duration-700">
            {/* Asset Ticker Row */}
            <div className="flex space-x-4 overflow-x-auto pb-4 no-scrollbar" style={noScrollbarStyle}>
                {inventory.slice(0, 8).map((item, i) => (
                    <div key={i} className="glass p-8 relative overflow-hidden group min-w-[200px]">
                        <div className="flex justify-between items-start mb-2">
                            <span className="text-slate-900 dark:text-white text-[9px] uppercase font-black tracking-widest">{item.category}</span>
                        ...
                        <div className="flex items-baseline space-x-2">
                            <span className="text-slate-900 dark:text-white font-serif font-black">₹{item.selling_price}</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 flex flex-col space-y-6">
                    <div className="glass p-8 flex-grow relative overflow-hidden">
                            ...
                            <div className="flex justify-between items-center mb-8">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">Revenue</span>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                                        <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">Profit</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        {[
                            ...
                            <div key={i} className="glass p-8 hover:-translate-y-1">
                                <div className="flex items-center space-x-3 mb-4">
                                    <div className={`p-2 rounded-lg bg-slate-200 dark:bg-slate-800 ${stat.color}`}>
                                        <stat.icon className="w-4 h-4" />
                                    </div>
                                    <span className="text-slate-900 dark:text-white text-[10px] uppercase font-black tracking-widest">{stat.label}</span>
                                </div>
                                <div className="text-2xl font-serif font-black text-slate-900 dark:text-white">{stat.value}</div>
                            </div>
                        ))}
                    </div>
                    ...
                    {lowStockItems.length > 0 && (
                        <div className="glass p-8 rounded-[3rem] border-rose-500/20 bg-rose-100 dark:bg-rose-950/80 mt-6 animate-pulse-slow">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-4">
                                    <div className="text-slate-700 dark:text-slate-200 text-[9px] uppercase font-black tracking-widest">Profit Stars</div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    {profitStars.length === 0 && <div className="text-[10px] text-white italic">Analyzing performance...</div>}
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-4">
                                    <div className="text-slate-900 dark:text-white text-[9px] uppercase font-black tracking-widest">Neural Optimization</div>
                                ...
                                <div className="space-y-3">
                                    {reorders.slice(0, 4).map((rec, i) => (
                                        <div key={i} className={`flex flex-col p-4 rounded-3xl border transition-all group ${rec.category === 'Critical' ? 'bg-rose-500/5 border-rose-500/20 hover:bg-rose-500/10' :
                                            rec.category === 'Warning' ? 'bg-amber-100 dark:bg-amber-950/80 border-amber-500/20 hover:bg-amber-200 dark:hover:bg-amber-900/80' :
                                                'bg-slate-200 dark:bg-slate-800 border-white/5 hover:bg-slate-300 dark:hover:bg-slate-700'
                                            }`}>
                                            ...
                                            {rec.category === 'Critical' ? (
                                                <div className="space-y-3 mt-1">
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="bg-black/20 p-2 rounded-xl border border-white/5">
                                                            <div className="text-[7px] font-black text-slate-300 uppercase tracking-widest mb-1">Forecast</div>
                                                            <div className="text-[10px] text-white font-bold">{rec.days_to_stockout} days left</div>
                                                        </div>
                                                        <div className="bg-black/20 p-2 rounded-xl border border-white/5">
                                                            <div className="text-[7px] font-black text-slate-300 uppercase tracking-widest mb-1">Avg Daily Sales</div>
                                                    ...
                                                    <div className="flex items-center justify-between group-hover:px-1 transition-all">
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className="text-[7px] text-slate-300 font-bold mt-1 uppercase tracking-tight">Lead Time: {rec.lead_time} days</span>
                                                        </div>
                                                        <button
                                                            onClick={() => document.getElementById('inventory-tab-btn')?.click()}
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex flex-col">
                                                        <span className={`text-[9px] font-black uppercase tracking-widest ${rec.category === 'Warning' ? 'text-amber-400' : 'text-slate-300'}`}>
                                                            {rec.status}
                                                        </span>
                                                        <span className="text-[7px] text-slate-300 font-bold uppercase tracking-tight mt-0.5">{rec.reason}</span>
                                                    </div>
                                                    <div className="text-[8px] text-white font-black uppercase tracking-widest">{rec.days_to_stockout}d Outlook</div>
                                                </div>
                                            )}
                                        </div>
                                    ))}
                                    {reorders.length === 0 && <div className="text-[10px] text-white italic">Core stock fully optimized.</div>}
                                </div>
                            </div>
                        </div>

                        {aiPredictions?.overspending?.alert && (
                            <div className="mt-8 p-4 rounded-2xl bg-red-100 dark:bg-red-950/80 border border-red-500/20">
                                <div className="flex items-center space-x-3 text-red-400">
                                    <AlertCircle className="w-3 h-3" />
                                    <span className="text-[9px] font-black uppercase tracking-widest">Baseline Deviation</span>
                                </div>
                                <div className="text-[10px] text-white mt-1">Spend exceeds average by ₹{aiPredictions?.overspending?.excess_amount}</div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="glass p-8 flex flex-col h-[400px]">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-xs font-bold uppercase tracking-widest text-slate-900 dark:text-white">Recent Stream</span>
                            </div>
                            <div className="text-[9px] font-black uppercase tracking-widest text-slate-900 dark:text-white">Live Updates</div>
                        </div>

                        <div className="flex-grow space-y-4 overflow-y-auto no-scrollbar pr-2">
                            {transactions.slice(0, 5).map((t, i) => (
                                <div key={i} className="flex items-center space-x-4 p-3 rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors border border-transparent hover:border-slate-200 dark:hover:border-white/5 group">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="text-[9px] text-slate-300 uppercase font-black tracking-widest">{new Date(t.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</div>
                                    </div>
