            ...
            <div className="relative z-10 w-full">
                    ...
                    <div className="max-w-[1240px] mx-auto px-6 md:px-12 flex justify-between items-center">
                        <div className="flex items-center space-x-4 md:space-x-5 group cursor-pointer">
                            ...
                            <div className="flex flex-col space-y-1">
                                ...
                                <span className="text-[10px] md:text-xs font-extrabold uppercase tracking-[0.3em] text-slate-800 dark:text-white mt-1 md:mt-2">Sales & Profit Analyzer</span>
                            </div>
                        </div>
                        <div className="hidden lg:flex space-x-6 items-center text-[10px] md:text-xs font-black uppercase tracking-widest">
                            <a href="#preview" className="bg-slate-200/50 dark:bg-slate-800 hover:bg-slate-300/80 dark:hover:bg-slate-700 text-slate-900 dark:text-white px-6 py-3 rounded-full border border-slate-900/10 dark:border-white/10 transition-all hover:scale-105 active:scale-95 shadow-sm">
                                Preview
                            </a>
                            <Link to="/login" className="bg-slate-200/50 dark:bg-slate-800 hover:bg-slate-300/80 dark:hover:bg-slate-700 text-slate-900 dark:text-white px-6 py-3 rounded-full border border-slate-900/10 dark:border-white/10 transition-all hover:scale-105 active:scale-95 shadow-sm">
                                Login
                            </Link>
                            ...
                            <button
                                onClick={toggleTheme}
                                className="p-3 rounded-full bg-slate-200/50 dark:bg-slate-800 border border-slate-900/10 dark:border-white/10 text-slate-700 dark:text-white hover:text-primary-500 dark:hover:text-primary-400 hover:bg-slate-300/80 dark:hover:bg-slate-700 transition-all hover:scale-105 active:scale-95 shadow-sm"
                        ...
                        <div className="lg:hidden flex items-center space-x-3">
                            <button
                                onClick={toggleTheme}
                                className="p-2.5 rounded-full bg-slate-200/50 dark:bg-slate-800 border border-slate-900/10 dark:border-white/10 text-slate-700 dark:text-white hover:text-primary-500 transition-all"
                                title={theme === 'dark' ? 'Switch to Light Mode' : 'Switch to Dark Mode'}
                            >
                                {theme === 'dark' ? <Sun className="w-4 h-4" /> : <Moon className="w-4 h-4" />}
                            </button>
                            <button
                                ...
                                className="px-8 py-4 rounded-2xl bg-white dark:bg-slate-700 text-slate-900 dark:text-white font-black text-sm uppercase tracking-widest shadow-xl hover:scale-105 transition-all duration-300 border border-slate-100 dark:border-white/5"
                            >
                                Login
                            </button>
                            <button
                                onClick={() => navigate('/signup')}
                                className="px-8 py-4 rounded-2xl bg-primary-500 text-white font-black text-sm uppercase tracking-widest shadow-xl hover:scale-105 transition-all duration-300 border border-primary-600"
                            >
                                Signup
                            </button>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-center gap-6 md:gap-12 py-8 border-y border-slate-400/20 backdrop-blur-sm bg-white/5 rounded-3xl lg:rounded-full px-6 md:px-12 w-full max-w-4xl mx-auto shadow-[0_0_40px_rgba(0,0,0,0.05)]">
                            {[
                                ...
                                <div key={i} className="text-center group cursor-default">
                                    ...
                                    <div className="text-[8px] md:text-[10px] text-slate-900 dark:text-white uppercase tracking-[0.2em] font-bold">{label}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section className="py-24 relative overflow-hidden">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <div className="bg-white/60 dark:bg-slate-900 border border-slate-200 dark:border-white/10 backdrop-blur-sm rounded-[3rem] md:rounded-[4rem] overflow-hidden relative group p-10 md:p-20 w-full">
                            <div className="max-w-4xl mx-auto flex flex-col items-center">
                                ...
                                <p className="text-slate-900 dark:text-white text-lg md:text-xl mb-14 max-w-xl mx-auto font-medium leading-relaxed">
                    ...
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 md:gap-6 max-w-6xl mx-auto">
                            {[
                                ...
                                <div key={i} className="glass p-8 md:p-10 rounded-3xl md:rounded-[3rem] shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group w-full sm:w-[calc(50%-1rem)] lg:w-[calc(25%-1.5rem)] min-w-[260px]">
                                    <div className="w-16 h-16 md:w-20 md:h-20 bg-primary-100 dark:bg-primary-500/20 rounded-2xl md:rounded-3xl flex items-center justify-center mb-6 md:mb-8 mx-auto group-hover:scale-110 group-hover:bg-primary-500/30 transition-all text-primary-600 dark:text-primary-400 drop-shadow-[0_0_15px_rgba(74,222,128,0.4)]">
                                        <feature.icon className="w-8 h-8 md:w-10 md:h-10" />
                                    </div>
                                    <h3 className="text-xl md:text-2xl font-serif mb-2 tracking-tight text-slate-900 dark:text-white">{feature.title}</h3>
                                    <p className="text-slate-900 dark:text-white leading-relaxed font-semibold text-xs md:text-sm">{feature.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section id="security" className="py-28">
                    <div className="max-w-[1200px] mx-auto px-6 text-center">
                        <div className="bg-white/50 dark:bg-white/[0.03] backdrop-blur-xl border border-slate-200/60 dark:border-white/10 p-10 md:p-20 rounded-[3rem] md:rounded-[4rem] relative overflow-hidden w-full shadow-2xl shadow-black/5">
                            ...
                            <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
                                ...
                                <h2 className="text-4xl md:text-7xl font-serif mb-12 leading-[1.1] tracking-tighter text-slate-900 dark:text-white">Your trust is <br /> our core foundation.</h2>
                                ...
                                <div className="flex flex-wrap justify-center gap-4 md:gap-8 w-full mb-10 max-w-3xl mx-auto">
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-center space-x-4 bg-slate-900/60 dark:bg-white/10 p-3 md:p-4 rounded-2xl md:rounded-[2rem] border border-slate-700/30 dark:border-white/20 group hover:bg-slate-900/80 dark:hover:bg-white/20 hover:scale-[1.03] hover:border-primary-500/50 hover:shadow-[0_0_30px_rgba(74,222,128,0.15)] transition-all cursor-pointer flex-grow min-w-[200px] backdrop-blur-sm">
                                ...
                                <div className="relative group mx-auto">
                                    ...
                                    <div className="relative glass p-10 md:p-12 rounded-3xl md:rounded-[4rem] border-white/20 shadow-2xl transform hover:rotate-2 transition-transform duration-500 max-w-xs mx-auto">
                                        ...
                                        <div className="text-2xl md:text-3xl font-serif mb-2 tracking-tight text-slate-900 dark:text-white">Verified Secure</div>
                                        <p className="text-slate-900 dark:text-white font-bold tracking-widest uppercase text-[8px] md:text-[10px]">Compliance Standard 2026</p>
                                    </div>
                                </div>
                            </div>
                        </div>
