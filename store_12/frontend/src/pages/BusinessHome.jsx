                        ...
                        <div className="space-y-12 pb-24">
                            ...
                            {aiPredictions && (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    <div className="glass p-6 bg-primary-500/5">
                                        ...
                                        <div className="text-2xl font-serif font-black text-slate-900 dark:text-white">{formatINR(aiPredictions.predictions['7_day'])}</div>
                                    </div>
                                    <div className="glass p-6 bg-blue-500/5">
                                        <div className="text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-widest mb-1">30-Day Forecast</div>
                                        <div className="text-2xl font-serif font-black text-slate-900 dark:text-white">{formatINR(aiPredictions.predictions['30_day'])}</div>
                                    </div>
                                    {aiPredictions.overspending.alert && (
                                        <div className="glass p-6 bg-red-500/5 col-span-1 md:col-span-2 flex items-center space-x-4 animate-pulse">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-slate-900 dark:text-white font-black opacity-80">Current spending is {formatINR(aiPredictions.overspending.excess_amount)} above average.</div>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-4">
                                <div>
                                    {!showAdvancedAnalytics && (
                                        <>
                                            <h2 className="text-2xl md:text-3xl font-serif font-black tracking-tight text-slate-900 dark:text-white mb-2">Profit & Loss</h2>
                                            <p className="text-slate-900 dark:text-white text-sm font-black">Visualizing your financial health for the last 6 months.</p>
                                        </>
                                    )}
                                </div>
                                <button
                                    onClick={() => setShowAdvancedAnalytics(!showAdvancedAnalytics)}
                                    className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white px-8 py-3 rounded-2xl text-xs font-bold uppercase tracking-widest flex items-center space-x-3 transition-all border border-slate-200 dark:border-white/10"
                                >
                                    {showAdvancedAnalytics ? (
                                        <>
                                            ...
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 md:px-5 py-2 rounded-2xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all duration-300 whitespace-nowrap ${reportGranularity === g.key
                                                        ...
                                                        : 'text-slate-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-500 hover:bg-primary-500/10 dark:hover:bg-primary-500/5'
                                                        }`}
                                                >
                                                    {g.label}
                                                </button>
                    ...
                    {activeTab === 'Inventory' && (
                        <div className="space-y-12 pb-24">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                                <div>
                                    <h2 className="text-2xl md:text-3xl font-serif font-black tracking-tight text-slate-900 dark:text-white">Inventory Management</h2>
                                    <p className="text-slate-900 dark:text-white text-sm font-black mt-1">Centralized Asset Ledger</p>
                                </div>
                            ...
                            {(role === 'Owner' || role === 'Accountant') && (
                                <div className="glass p-8 md:p-10 rounded-2xl border-slate-200 dark:border-white/5 bg-white dark:bg-slate-900 shadow-2xl relative overflow-hidden group">
                                    ...
                                    <div className="flex justify-between items-center mb-8 relative">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-serif font-black tracking-tight text-slate-900 dark:text-white">{isEditingItem ? 'Edit Product' : 'Add New Item'}</h3>
                                                <p className="text-slate-900 dark:text-white text-[9px] uppercase tracking-widest font-black">Configure item specifications</p>
                                            </div>
                                        </div>
                                        {isEditingItem && (
                                            <button
                                                ...
                                                className="text-xs text-slate-900 dark:text-white hover:text-white uppercase tracking-widest font-bold transition-colors"
                                            >
                                                Cancel Edit
                                            </button>
                                        )}
                                    ...
                                    <form onSubmit={async (e) => {
                                        ...
                                        <div className="md:col-span-1">
                                            ...
                                            <input
                                                type="number"
                                                className="w-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-white/10 rounded-2xl py-4 px-6 text-slate-900 dark:text-white text-sm font-bold focus:border-primary-500/50 transition-all"
                                ...
                                return (
                                    <div key={idx} className="space-y-6">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <h3 className="text-3xl font-serif font-black tracking-tight text-slate-900 dark:text-white">{section.title}</h3>
                                        </div>
                                                ...
                                                <table className="w-full text-left min-w-[800px]">
                                                    <thead>
                                                        <tr className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-white/10">
                                                            <th className="p-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white">Item Details</th>
                                                            <th className="p-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white">Financials</th>
                                                            <th className="p-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white">Performance</th>
                                                            <th className="p-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white">Availability</th>
                                                            {(role === 'Owner' || role === 'Accountant') && (
                                                                <th className="p-8 text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white text-right">Actions</th>
                                                            )}
                                                        </tr>
                                                    </thead>
                                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                                        {paginatedProducts.length === 0 ? (
                                                            ...
                                                            paginatedProducts.map(item => (
                                                                <tr key={item.id} className="group hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors border-slate-200 dark:border-white/5">
                                                                    <td className="p-8">
                                                                        <div className="flex items-center space-x-3 mb-1">
                                                                        ...
                                                                        <div className="text-[10px] text-slate-900 dark:text-white font-bold uppercase tracking-widest line-clamp-1">{item.description || item.category}</div>
                                                                    </td>
                                                                    <td className="p-8">
                                                                        <div className="text-xl font-serif text-primary-400 mb-1">{formatINR(item.selling_price)}</div>
                                                                        <div className="text-[9px] text-slate-900 dark:text-white font-black uppercase tracking-tighter">Basic Cost: {formatINR(item.cost_price || 0)}</div>
                                                                    </td>
                                                                    <td className="p-8">
                                                                        ...
                                                                        <div className="flex items-center space-x-2">
                                                                            <span className="text-[9px] text-slate-900 dark:text-white font-black uppercase tracking-tighter">ROI:</span>
                                                                    ...
                                                                    <td className="p-8">
                                                                        <div className="flex flex-col space-y-2">
                                                                            <div className="flex items-center space-x-3">
                                                                                <div className="w-20 h-1.5 bg-slate-200 dark:bg-slate-900 rounded-full overflow-hidden">
                                                                                    <div
                                                ...
                                                <div className="px-6 py-4 bg-slate-50 dark:bg-white/[0.02] border-t border-slate-200 dark:border-white/5 flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <button
                                                            ...
                                                            className="px-3 py-1.5 rounded-lg text-xs font-black bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 dark:hover:bg-slate-700 transition-all text-slate-900 dark:text-white"
                                                        >
                                                            Prev
                                                        </button>
                                                        <div className="text-xs font-black text-slate-900 dark:text-white px-2">
                    ...
                    {activeTab === 'Transactions' && (
                        <div className="space-y-8">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                                <div>
                                    <h2 className="text-2xl md:text-3xl font-serif font-black tracking-tight text-slate-900 dark:text-white">Transaction Logs</h2>
                                    <p className="text-slate-900 dark:text-white text-sm font-black mt-1">Live Transaction Stream</p>
                                </div>
                                    ...
                                    {(role === 'Owner' || role === 'Accountant' || role === 'Analyst' || role === 'owner') && (
                                        <>
                                            ...
                                            <button
                                                ...
                                                className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-white/10 px-6 py-4 rounded-2xl text-[10px] uppercase tracking-[0.2em] font-black hover:bg-slate-50 dark:hover:bg-slate-700 transition-all active:scale-95 flex items-center space-x-3"
                                            >
                                            ...
                                            {paginatedTransactions.map(txn => (
                                                <div key={txn.id} className="glass p-6 rounded-2xl border-slate-200 dark:border-white/5 flex items-center justify-between hover:border-slate-300 dark:hover:border-white/10 transition-colors group">
                                                    <div className="flex items-center space-x-6">
                                                        ...
                                                        <div>
                                                            <div className="text-slate-900 dark:text-white text-lg font-black">{txn.description || txn.category}</div>
                                                            <div className="text-slate-900 dark:text-white text-xs font-black uppercase tracking-widest flex items-center">
                                                ...
                                                <div className="glass p-6 rounded-2xl border-slate-200 dark:border-white/5 flex items-center justify-between mt-6">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        <button
                                                            ...
                                                            className="px-4 py-2 rounded-xl text-sm font-bold bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 dark:hover:bg-white/10 transition-all"
                                                        >
                                                            Previous
                                                        </button>
                                                            ...
                                                            {Array.from({ length: totalPages }, (_, i) => i + 1).map(pageNum => (
                                                                <button
                                                                    ...
                                                                    className={`w-10 h-10 rounded-xl text-sm font-bold transition-all ${pageNum === transactionPage
                                                                        ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/20'
                                                                        : 'bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/10'
                                                                        }`}
                                                                >
                                                                    {pageNum}
                                                                </button>
                    ...
                    {activeTab === 'Staff' && (
                        <div className="space-y-6">
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    <h2 className="text-2xl md:text-3xl font-serif font-bold tracking-tight text-slate-900 dark:text-white">Team Management</h2>
                                    <p className="text-slate-900 dark:text-white">Manage access and roles for your organization</p>
                                </div>
                                {role === 'Owner' && (
                                    <button
                            ...
                            {isLoadingMembers ? (
                                <div className="p-12 text-center glass rounded-3xl">
                                    ...
                                    <p className="text-slate-900 dark:text-white">Loading team...</p>
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        <div key={member.user_id} className="glass p-8 rounded-[2.5rem] border-slate-200 dark:border-white/5 group hover:border-primary-500/30 transition-all relative overflow-hidden">
                                            ...
                                            <div className="flex items-center space-x-4 mb-6 relative z-10">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-slate-900 dark:text-white text-xs truncate max-w-[150px]">{member.email}</p>
                                                </div>
                                            </div>

                                            <div className="flex flex-col space-y-4 relative z-10">
                                                <div className="flex justify-between items-center">
                                                    <span className="text-[10px] uppercase font-bold tracking-widest text-slate-900 dark:text-white">Current Role</span>
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <span className="text-[10px] uppercase font-bold tracking-widest text-slate-900 dark:text-white">Joined</span>
                                                    <span className="text-xs font-bold text-slate-900 dark:text-white">{member.joined_at}</span>
                                                </div>
                                            </div>
                                            ...
                                            {role === 'Owner' && member.email !== user.email && (
                                                <div className="mt-8 pt-6 border-t border-slate-100 dark:border-white/5 flex space-x-3 relative z-10">
                                                    <button
                                                        ...
                                                        className="flex-grow bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-50 dark:hover:bg-slate-700 transition-all"
                                                    >
                                                        Edit Role
                                                    </button>
                                                    <button
                                    ...
                                    {members.length === 0 && (
                                        <div className="col-span-full p-20 text-center glass rounded-[3rem] border-dashed border-slate-300 dark:border-white/10">
                                            ...
                                            <p className="text-slate-900 dark:text-white font-serif text-xl italic">No team members found</p>
                                        </div>
                                    )}
                                </div>
                            )}
